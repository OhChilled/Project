...
У цьому проєкті модульні тести використовуються не лише для перевірки правильності роботи коду, а і як приклади використання функцій.

Такий підхід називається Test-Driven Documentation.

## 📖 Це означає, що:

тести демонструють, як викликати функції
показують очікувані результати
виступають як "жива" документація
...
що функція повертає значення за формулою
🔹 Функція fy
...
Демонструє використання формули для fy
...
обчислення відстані
що результат завжди невід’ємний
...
приклад використання методу Рунге-Кутти
контрольний випадок без прискорення

## ▶️ Як запустити тести
