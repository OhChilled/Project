...
У проєкті підтримується документація двома мовами:
...
Документація автоматично генерується за допомогою **Doxygen** та публікується через **GitHub Pages**.

## 🚀 Автоматична публікація

Після push у гілку `main` GitHub Actions:
...
У проєкті використовується документування у стилі Doxygen.

Усі публічні функції, структури та методи повинні містити:

- короткий опис (`@brief`)
- опис параметрів (`@param`)
- опис результату (`@return`), якщо функція щось повертає

Рекомендації:
- документувати призначення функції просто і коротко
- пояснювати фізичний зміст параметрів
- оновлювати документацію при зміні коду
